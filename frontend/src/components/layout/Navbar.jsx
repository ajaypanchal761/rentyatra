    ...
    <nav className="bg-white border-b border-gray-200 sticky top-0 z-50 shadow-sm">
      <div className="max-w-7xl mx-auto px-2 md:px-3">
        ...
        <div className="flex items-center justify-between h-14">
          ...
          {/* Right Side - Location and User/Login */}
          <div className="flex items-center gap-2 md:gap-3">
            {/* Location Selector - Right End */}
            <div className="relative">
              ...
              >
                ...
                <span className="text-xs md:text-sm font-medium text-gray-900 truncate max-w-[100px] md:max-w-[150px]">
        ...
        {/* Bottom Row - Search Bar with Heart and Bell Icons */}
            ...
            <form onSubmit={handleSearch} className="flex-1">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 pl-12 pr-12 border-2 border-gray-900 rounded focus:outline-none focus:border-[#23e5db] transition-all text-sm md:text-base"
                />
                <button
                  type="button"
